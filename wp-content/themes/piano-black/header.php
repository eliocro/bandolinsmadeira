...
<div id="wrapper">
 ...
 <div id="pngfix-right"></div>
  ...
  <div id="header">
   ...
   <div id="socialme-col">
		  <a href="http://www.facebook.com/bandolinsmadeira" title="On facebook!" target="_blank"><img src="<?php bloginfo('template_url'); ?>/social.me/facebook.png" ></a> 
		  <a href="http://picasaweb.google.pt/galeria.abm" title="Photos on Picasa Web Albums" target="_blank"><img src="<?php bloginfo('template_url'); ?>/social.me/picasa.png" ></a> 
		  <a href="http://www.youtube.com/bandolinsmadeira" title="Videos on Youtube" target="_blank"><img src="<?php bloginfo('template_url'); ?>/social.me/youtube.png" ></a>
		  <!--img src="<?php bloginfo('template_url'); ?>/social.me/feed.png" > 
		  <img src="<?php bloginfo('template_url'); ?>/social.me/wordpress.png" --> 
	</div>
